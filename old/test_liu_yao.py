...
def format_divination_results(bazi, result_json, yao_list, show_shen_sha: bool = True, for_gradio: bool = False) -> str:
    ...
    output_parts.append(f"天干地支曆: {bazi.year.to_string()}年 {bazi.month.to_string()}月 {bazi.day.to_string()}日 {bazi.hour.to_string()}時\n")
    ...
    output_parts.append(format_liu_yao_display(yao_list, show_shen_sha=show_shen_sha, for_gradio=for_gradio) + "\n")
    # Header
    output_parts.append("""
